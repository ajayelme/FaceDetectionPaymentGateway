    ...
    public partial class FacePayTransaction : Form
    {
        ...
        void TransactionWithPay()
        {
            if (label4.Text != "")
            {
                ...
                {
                    int Account_ID = 0;
                    SqlConnection conn = new SqlConnection("Data Source=NAG1-LHP-N07060\\SQLEXPRESS;Initial Catalog=IDEOLOGY_BANK;Integrated Security=True");
                    ...
                    if (DR.Read())
                    {
                        ...
                        if (Convert.ToInt32(txtPayAmount.Text) < Total_Amount)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                string InsertAccuntDetails = "insert into AccountDetails values ('" + Balance + "','" + txtPayAmount.Text + "','" + "Self" + "','" + DateTime.Today.ToShortDateString() + "','" + Balance + "','" + Account_ID + "')";
